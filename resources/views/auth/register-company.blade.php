    ...
    <div class="stepper-container mt-4">
      <div class="card">
        <div class="card-header text-center">
          <h4 class="mb-0"><i class="bi bi-building-fill me-2"></i>Register</h4>
          <p class="mb-0 mt-2">Buat akun perusahaan untuk mengakses semua fitur</p>
        </div>
        <div class="card-body p-4">
          ...
          <div class="step-indicator">
            <div class="step-item active" data-step="1">
              ...
              <div class="step-label">Informasi Perusahaan</div>
            </div>
          ...
          <form id="registerForm" action="{{ route('register.company') }}" method="POST">
            ...
            <div class="step" id="step-2">
              ...
              <div class="mb-4">
                <label for="corporate_field_id" class="form-label">Bidang Perusahaan</label>
                <div class="input-group">
                  <span class="input-group-text"><i class="bi bi-briefcase-fill"></i></span>
                  <select class="form-select" id="corporate_field_id" name="corporate_field_id" required>
                    <option value="" selected disabled>-- Pilih Bidang Perusahaan --</option>
              ...
              <div class="mb-4">
                <label for="employee" class="form-label">Jumlah Karyawan</label>
                <div class="input-group">
                  <span class="input-group-text"><i class="bi bi-people-fill"></i></span>
                  <input type="number" class="form-control" id="employee" name="employee" placeholder="Masukkan jumlah karyawan" required>
                </div>
              </div>
            </div>
          </form>
